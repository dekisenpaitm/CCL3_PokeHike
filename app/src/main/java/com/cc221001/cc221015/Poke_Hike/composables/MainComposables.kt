...
fun ContentList() {
    ...
    LazyColumn(
        ...
        item {
            CustomContainerBlurry(200, 200, 20, "This is Text", null)
...
fun CustomContainerBlurry(
    ...
    // Wrap the entire CustomContainerBlurry with Cloudy
    Box(modifier = Modifier.fillMaxWidth(), contentAlignment = Center) {
        // Cloudy with blurred container
        Box(
            modifier = Modifier.fillMaxWidth(),
            contentAlignment = Center
        ) {
            // Moved content inside the Surface
            Surface(
                modifier = Modifier
                    .width(w.dp)
                    .height(h.dp)
        ...
        // Text outside the blurred container with a semi-transparent background
        Box(
            modifier = Modifier
                .fillMaxSize()
                .padding(16.dp),
