...
fun CreatePokeballEntries(pokeballViewModel: PokeballViewModel){
    ...
    pokeballViewModel.createPokeball( "WanderBall", "Clouds", "Fairy", "Fighting", "Psychic",10, "https://archives.bulbagarden.net/media/upload/6/6a/Bag_Dream_Ball_SV_Sprite.png")
    pokeballViewModel.createPokeball( "ThunderBall", "Thunderstorm", "Electric", "Flying", "Dragon",10, "https://archives.bulbagarden.net/media/upload/5/52/Bag_Dive_Ball_SV_Sprite.png")
    pokeballViewModel.createPokeball( "AquaBall", "Drizzle", "Water", "Ice", "Electric",10, "https://archives.bulbagarden.net/media/upload/b/b1/Bag_Dusk_Ball_SV_Sprite.png")
    pokeballViewModel.createPokeball( "PourBall",  "Rain", "Water", "Electric", "Bug",10, "https://archives.bulbagarden.net/media/upload/3/3c/Bag_Fast_Ball_SV_Sprite.png")
    ...
    pokeballViewModel.createPokeball( "MysticBall", "Mist", "Ghost", "Dark", "Fairy",10, "https://archives.bulbagarden.net/media/upload/4/40/Bag_Love_Ball_SV_Sprite.png")
    ...
    pokeballViewModel.createPokeball( "RockyBall", "Dust", "Ground", "Rock", "Steel",10, "https://archives.bulbagarden.net/media/upload/5/54/Bag_Great_Ball_SV_Sprite.png")
    pokeballViewModel.createPokeball( "GhostlyBal",  "Fog", "Ghost", "Dark", "Fairy",10, "https://archives.bulbagarden.net/media/upload/2/26/Bag_Moon_Ball_SV_Sprite.png")
    pokeballViewModel.createPokeball( "GrainBall", "Sand", "Ground", "Rock", "Steel",10, "https://archives.bulbagarden.net/media/upload/3/3d/Bag_Nest_Ball_SV_Sprite.png")
    pokeballViewModel.createPokeball( "BlazeBall", "Ash", "Fire", "Ground", "Rock",10, "https://archives.bulbagarden.net/media/upload/5/59/Bag_Luxury_Ball_SV_Sprite.png")
    ...
    pokeballViewModel.createPokeball( "WhirlBall", "Tornado", "Flying", "Dragon", "Fighting",10, "https://archives.bulbagarden.net/media/upload/4/48/Bag_Strange_Ball_SV_Sprite.png")
